...
const FEATURES = [
  {
    ...
    body: "We match on identity, intention, communication, values, and emotional readiness — not on who's a block away.",
    icon: (
      <path
  ...
  },
  {
    ...
    body: "You'll know what someone is here for before you send a single message. No second-guessing, no decoding.",
    icon: (
      <>
  ...
  },
  {
    ...
    body: "Open with a thoughtful prompt instead of an empty 'hey'. Start where it actually gets interesting.",
    icon: (
      <path
  ...
  },
  {
    ...
    body: "An AI-assisted safety layer and a human review team protect emotional safety across the LGBTQIA+ community.",
    icon: (
      <path
...
function FeatureIcon({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-blush-200 via-lilac-200 to-sky2-200 text-plum-800 ring-1 ring-inset ring-white/80">
    ...
    <main>
        ...
        <div className="mx-auto max-w-6xl px-5 pt-16 pb-12 md:pt-24">
          <div className="grid items-center gap-12 md:grid-cols-[1.05fr_0.95fr]">
            <div className="animate-rise-in">
              <span className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/70 px-3 py-1.5 text-xs uppercase tracking-[0.22em] text-plum-700">
                <span className="h-1.5 w-1.5 rounded-full bg-gradient-to-br from-blush-300 to-sky2-300" />
                Premium LGBTQIA+ relationship app
              </span>
              <h1 className="mt-6 font-display text-5xl leading-[1.05] tracking-tight text-plum-800 md:text-7xl">
                <span className="text-gradient">Afterglow</span>
              </h1>
              <p className="mt-5 max-w-xl font-display text-2xl leading-snug text-plum-800 md:text-3xl">
                Because dating should feel human again.
              </p>
              <p className="mt-5 max-w-xl text-base leading-relaxed text-plum-600 md:text-lg">
                A relationship-focused dating app for the LGBTQIA+ community —
                designed for people seeking real connection, emotional depth,
              ...
              <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-plum-500">
      ...
      <section className="px-5">
        <div className="mx-auto max-w-6xl">
          <GlowCard className="px-6 py-7 md:px-10" tone="tint">
            <div className="flex flex-col items-start justify-between gap-3 md:flex-row md:items-center">
              ...
              <p className="max-w-xl text-sm text-plum-600 md:text-base">
                ...
                nonbinary, and questioning folks who are ready to be seen, not
                just scrolled past.
              </p>
            </div>
          </GlowCard>
      ...
      <section id="how-it-works" className="px-5 pt-20">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-base text-plum-600 md:text-lg">
              Afterglow trades the dopamine of endless swiping for something
              steadier — a small, thoughtful list of people who could actually
              fit the life you're building.
            </p>
          </div>
            ...
            {[
              {
                ...
                body: "Share your identity, your intentions, your values, and the things you'd rather not be sent. We listen carefully.",
              },
              {
                step: "02",
                title: "Meet five, not five hundred",
                body: "Each morning, a curated compatibility list — and a playful astro layer if you're into a little cosmic timing.",
              },
              {
                step: "03",
                title: "Start with a real conversation",
                body: "Open with a thoughtful prompt that means something. An AI-assisted safety layer keeps things respectful.",
              },
            ].map((s) => (
              <div key={s.step} className="relative">
                ...
                <h3 className="mt-3 font-display text-xl text-plum-800">
                  {s.title}
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-plum-600">
                  {s.body}
      ...
      <section className="px-5 pt-24">
        <div className="mx-auto max-w-4xl text-center">
          <GlowCard className="px-6 py-10 md:px-12 md:py-14" tone="tint">
            <p className="text-xs uppercase tracking-[0.24em] text-plum-500">
              Our quiet promise
            </p>
            <p className="mt-4 font-display text-2xl leading-snug text-plum-800 md:text-3xl">
              No map. No exact distance. No 'online now' grid. No infinite scroll.
              Just five people a day across the LGBTQIA+ community who could
              actually fit the life you're building.
            </p>
    ...
    <div className="flex h-full w-full flex-col">
      ...
      <div className="mt-4 flex-1 space-y-3 overflow-hidden">
        {[
          ...
          { name: "Rhea", accent: "lilac" as const, pct: 88, label: "she/her" },
          { name: "Sam", accent: "blush" as const, pct: 86, label: "they/them" },
        ].map((p) => (
          <div
            key={p.name}
            className="flex items-center gap-3 rounded-2xl border border-white/85 bg-white/65 p-3"
          >
            ...
            <div className="rounded-full bg-white/80 px-2 py-0.5 text-[10px] font-medium tabular-nums text-plum-800 ring-1 ring-inset ring-plum-200/40">
              {p.pct}%
            </div>
          </div>
        ))}
